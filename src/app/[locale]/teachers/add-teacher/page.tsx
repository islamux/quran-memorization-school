  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const newTeacher: Teacher = {
        ...
        schedule: [], // Initialize empty schedule array
        isDeleted: false // Ensure the teacher is not marked as deleted
      };
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4 rtl:space-x-reverse">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">{t('teachersPage.addNewTeacher')}</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          >
            {isSubmitting ? 'جاري الإضافة...' : t('teachersPage.addNewTeacher')}
          </Button>
          <Button
            type="button"
            variant="outline"
