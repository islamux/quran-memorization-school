              ...
              {recentStudents.map((student) => (
                <div key={student.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{tCommon(`grades.${student.grade}`, { defaultValue: student.grade })} • {tCommon(`surahs.${student.currentSurah}`, { defaultValue: student.currentSurah })}</p>
                  </div>
